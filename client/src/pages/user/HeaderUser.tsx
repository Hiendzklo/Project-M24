            ...
            {username ? (
              <div className="relative group">
                ...
                <div className="absolute right-0 mt-1 w-48 bg-white text-black rounded shadow hidden group-hover:block">
                  <Link to="/my-account" className="block px-4 py-2 hover:bg-gray-300">Tài Khoản Của Tôi</Link>
                  <a href="#" className="block px-4 py-2 hover:bg-gray-300">Đơn Mua</a>
        ...
        <div className="container mx-auto flex justify-between items-center py-4">
          <div className="flex items-center">
            ...
            <input
              ...
              className="ml-4 px-4 py-2 rounded-l-full w-[900px]"
            />
            <button className="bg-white text-red-500 px-4 py-2 rounded-r-full">
              <svg
